...
<!-- article end -->
      ...
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          ...
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15407</h3>
            <h1 class="fw-bold">Prasetyo Bayu Aji Pamungkas</h1>
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        ...
        ></a>
        <a href="https://wa.me/+6285226105820"
          ><i class="bi bi-whatsapp h2 p-2"></i
        ></a>
      </div>
      <div>Prasetyo Bayu Aji Pamungkas &copy; 2025</div>
    </footer>
    <!-- footer end -->
